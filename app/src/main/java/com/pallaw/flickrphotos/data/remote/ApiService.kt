...
import com.pallaw.flickrphotos.data.model.PhotoInfoResponse
...
interface ApiService {
    ...
    @Headers("content-type: application/json")
    @GET("/services/rest/?method=flickr.photos.getInfo&format=json&nojsoncallback=1&api_key=25b6ea7cf47427f19898a3e98b8bf1e3")
